    ...
    <div class="container site-section">
        <div class="row">
            <div class="col-6 title-section">
                <h2 class="heading">Join our SAFA Team</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">Become a Player</a></h3>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">Register Team</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">Be a Referee</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">Become a Coach</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">FAQ/Join Community</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
