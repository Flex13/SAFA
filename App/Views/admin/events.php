...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
            <h2 class="mt-4"><img src="<?=AUTH_ASSETS?>img/logo.png" alt="SAFA Buffalo City Logo" height="70">Events
            </h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 mb-4">
                        <div class="card">
                            <img style="height: 250px;" src="<?=BACK_ASSETS?>images/blog/transparent.png"
                                class="card-img-top img-fluid" alt=" Image">
                            <div class="card-body">
                                <h5 class="card-title">Event 1</h5>
                                <h6 class="card-subtitle mb-2 text-muted ">About Event</h6>
