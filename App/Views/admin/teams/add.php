...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="container-fluid px-4">
            <h2 class="mt-4"><img src="<?=AUTH_ASSETS?>img/logo.png" alt="SAFA Buffalo City Logo" height="70"> Create
                Team</h2>
                        ...
                        <div class="card-body">
                            ...
                            <form id="BTSFORM" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input placeholder="Team Name" value="<?=get_var('name')?>" type="text" id="name"
                                        name="name" class="form-control" required autofocus />
                                </div> <!-- form-group// -->

                                <div class="mb-3">
                                    <label for="short_name" class="form-label">Short Name:</label>
                                    <input placeholder="Short Name" value="<?=get_var('short_name')?>" type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="<?=get_var('location')?>" type="text" name="location" id="location"
