        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-9 mx-auto text-center">
                    <h1 class="text-white">Leagues</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container site-section">
        <div class="row">
            <div class="col-6 title-section">
                <h2 class="heading">BCM Leagues</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">ABC Motsepe League </a></h3>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">Sasol Women’s League</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">SAB League</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">SAFA BCM Women’s Regional League</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="custom-media d-flex aboutCards">
                    ...
                    <div class="text">
                        <h3 class="mb-4"><a href="#">SAFA BCM Inter-LFA League</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus deserunt saepe tempora
                            dolorem.</p>
                        <p><a class="aboutTag" href="#">Read more</a></p>
                    </div>
