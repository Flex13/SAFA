                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="BTSForm" autocomplete="on">
                            <div class="form-group">
                                ...
                                <input value="<?=get_var('firstname')?>" autocomplete="cc-given-name" id="firstname"
                                    type="text" class="form-control" name="firstname" required autofocus>
                            </div>

                            <div class="form-group">
                                <label for="lastname">Last Name</label>
                                <input value="<?=get_var('lastname')?>" id="lastname" type="text" class="form-control"
                                    name="lastname" required autocomplete="cc-family-name">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=get_var('cell')?>" autocomplete="tel" id="cell" type="tel"
                                    class="form-control" name="cell" required>
                            </div>

                            <div class="form-group">
                                <label for="gender" class="form-label">Gender</label>
                                <select id="gender" name="gender" class="my-2 form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?=get_var('password')?>" autocomplete="current-password" id="password"
                                    type="password" class="form-control" name="password" required data-eye>
                            </div>

                            <div class="form-group">
                                <label for="passwordC">Password</label>
                                <input value="<?=get_var('passwordC')?>" autocomplete="current-password" id="passwordC"
                                    type="password" class="form-control" name="passwordC" required data-eye>
                            </div>
                            ...
                            <div class="mt-4 text-center">
                                Already have an account? <a href="<?=ROOT?>auth">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
